<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExcusePriorities.aspx.cs" Inherits="QProcess.ExcusePriorities"  MasterPageFile="PrioritiesScheduling.master" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script type="text/javascript">
        ...
        {
            syncPost("GetPriorityListScheduleReportExcuse", JSON.stringify({ startDate: $("#txtStartDate").val(), endDate: $("#txtEndDate").val() }));
            $("#tblScheduleReport").html(syncPostResult);
