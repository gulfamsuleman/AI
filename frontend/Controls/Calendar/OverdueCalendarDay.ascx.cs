...
{
	public partial class Controls_Calendar_OverdueCalendarDay : System.Web.UI.UserControl
	{
		...
		public Controls_Calendar_OverdueCalendarDay()
		{
		...
		protected string GetLinkStyle(bool isActive, DateTime dueDate, TaskStage taskStage, bool reminder, bool alert)
		{
			string linkStyle = "";
