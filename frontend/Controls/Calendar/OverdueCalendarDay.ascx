<%@ Control Language="C#" AutoEventWireup="true" Codebehind="OverdueCalendarDay.ascx.cs" Inherits="QProcess.Controls.Controls_Calendar_OverdueCalendarDay" %>
            ...
            <ItemTemplate>
                <div class="dayofweekDiv">
                    <a style="display: inline;" href="#"
                        ...
                        class="<%# GetLinkStyle((bool) Eval("Active"), (DateTime) Eval("DueTime"), (TaskStage)Eval("TaskStage"),
