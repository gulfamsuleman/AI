<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OverdueTaskReport.aspx.cs" Inherits="QProcess.OverdueTaskReport" MasterPageFile="OverdueTasksChargeMonitor.master" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script type="text/javascript">
        ...
        function GetOverdueTasksReport()
        {
            syncPost("GetOverdueTasksReport", JSON.stringify({ startDate: $("#txtStartDate").val(), endDate: $("#txtEndDate").val(), employee: $("#ddlPriorityEmployees option:selected").text() }));
            $("#tblScheduleReport").html(syncPostResult);
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="MainContent">
  ...
  <select id="ddlPriorityEmployees">
     ...
     <input id="btnGo" style="width: 40px; height: 25px; text-align: center; vertical-align: top;"  type="button" value="Go" onclick="GetOverdueTasksReport()" />
    </div>
 </div>
