...
(function () {
    ...
    // Frogslayer Edit
    lw_dp_today_button_class = 'lw-dp-today-button';

    lw_dp_monthbar_class = 'lw-dp-monthbar';

    lw_dp_yearbar_class = 'lw-dp-yearbar';

    lw_dp_next_year_class = 'lw-dp-next-year';

    lw_dp_previous_year_class = 'lw-dp-previous-year';

    lw_dp_year_class = 'lw-dp-year';
    // End Frogslayer Edit
    ...
    LightweightDatepicker = (function () {
        ...
        function LightweightDatepicker(el, settings) {
            ...
            this.showNextYear = __bind(this.showNextYear, this);

            this.showPreviousYear = __bind(this.showPreviousYear, this);
            ...
            //note: FrogSlayer edit for jquery-1.9.1 compatibility
        ...
        LightweightDatepicker.prototype._createDatepicker = function () {
            ...
            this.yearBar = $("<div class=" + lw_dp_yearbar_class + "/>").appendTo(this.toolbar);
            this.nextYear = $("<div class=" + lw_dp_next_year_class + "/>").appendTo(this.yearBar);
            this.previousYear = $("<div class=" + lw_dp_previous_year_class + "/>").appendTo(this.yearBar);
            this.year = $("<div class=" + lw_dp_year_class + "/>").appendTo(this.yearBar);
            //			$("<br />").appendTo(this.toolbar);
            this.monthBar = $("<div class=" + lw_dp_monthbar_class + "/>").appendTo(this.toolbar);
            this.previous = $("<div class=" + lw_dp_previous_class + "/>").appendTo(this.monthBar);
            this.next = $("<div class=" + lw_dp_next_class + "/>").appendTo(this.monthBar);
            this.month = $("<div class=" + lw_dp_month_class + "/>").appendTo(this.monthBar);
            this._renderDows().appendTo(this.wrapper);
            this.days = $('<div/>').appendTo(this.wrapper);
            // Frogslayer Edit
            return this.today = $("<div class=" + lw_dp_today_button_class + "><button data-role='today' style='margin-top: 4px;'>Today</button></div>").appendTo(this.wrapper);
        ...
        LightweightDatepicker.prototype._bindEvents = function () {
            ...
            // Frogslayer edit
            this.monthBar.delegate("." + lw_dp_next_class, event, this.showNextMonth);
            this.monthBar.delegate("." + lw_dp_previous_class, event, this.showPreviousMonth);
            this.yearBar.delegate("." + lw_dp_next_year_class, event, this.showNextYear);
            this.yearBar.delegate("." + lw_dp_previous_year_class, event, this.showPreviousYear);
            this.today.delegate("button[data-role='today']", event, _this, this.setToday);
            // End Frogslayer edit
        ...
        LightweightDatepicker.prototype._updateMonth = function () {
            var cd, date, day, daysInFirstWeek, daysInMonth, daysInPreviousMonth, firstDayDow, firstDayOfNextMonth, html, lastDayOfPreviousMonth, lastDowIndex, renderDay, week, weeks, _i, _j,
			  _this = this;
            this.month.html(this.settings.monthNames[this.currentDate.getMonth()]);
            // Frogslayer edit
            this.year.html(this.currentDate.getFullYear());
            cd = this.currentDate;
        ...
        // Frogslayer Edit
        LightweightDatepicker.prototype.showPreviousYear = function () {
            return this.setCurrentDate(new Date(this.currentDate.getFullYear() - 1, this.currentDate.getMonth(), this.currentDate.getDate()));
        };

        LightweightDatepicker.prototype.showNextYear = function () {
            return this.setCurrentDate(new Date(this.currentDate.getFullYear() + 1, this.currentDate.getMonth(), this.currentDate.getDate()));
        };
        // End Frogslayer Edit
        ...
        // Frogslayer Edit
        LightweightDatepicker.prototype.setToday = function (e) {
            e.data.setActiveDate(new Date());
