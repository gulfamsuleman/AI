<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MobileTaskSummary.aspx.cs" Inherits="QProcess.Mobile.MobileTaskSummary" MasterPageFile="Mobile.master" %>
...
<asp:Content ID="head" runat="server" ContentPlaceHolderID="headContent">
    ...
    <script>
        var mobileTitle = "Task Summary";
    </script>
</asp:Content>

<asp:Content ID="main" runat="server" ContentPlaceHolderID="formContent">
    <div id="task-summary-panel">
	<img src="/Images/reports.gif" />
	<h3 style="display:inline-block; vertical-align: bottom">Task Summary</h3>
	...
	<div>
		<div class="form-group">
			...
			assigned to 
			<asp:DropDownList CssClass="form-control" ID="assignedtoList" runat="server" AutoPostBack="true"></asp:DropDownList>
		</div>
		<div class="form-group">
			<input type="button" class="btn btn-secondary" value="N/A selected Tasks" id="btnNA" />
			 <br />Reason: <br /> <textarea id="nareason" class="form-control" rows="4"></textarea>
		</div>
		<div id="naresults">
			<table>
				<tr>
	...
	<div id="summary-tasks-table" class="task-table-wrapper" data-drop-sid="-1">
		<div class="collapsible-item" data-collapse-state="collapsed" data-task-type="1">
	...
	<div id="status-tasks-table" class="task-table-wrapper">
		<div class="collapsible-item" data-collapse-state="collapsed" data-task-type="2">
			<div class="title-bar" data-collapse-target="true">
				<i class='fa fa-plus-square-o' data-role='expand-indicator'></i>
