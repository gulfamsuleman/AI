...
LOGGING = {
    ...
    'handlers': {
        ...
        'stored_procedure_file': {
            'class': 'logging.FileHandler',
            'filename': BASE_DIR / 'logs' / 'stored_procedure.log',
            'formatter': 'detailed',
            'level': 'INFO',
        },
        'error_file': {
    ...
    'loggers': {
        ...
        'chatbot.services.task_service': {
            'handlers': ['console', 'stored_procedure_file'],
            'level': 'INFO',
            'propagate': False,
        },
        'chatbot.services.database_service': {
            'handlers': ['console', 'stored_procedure_file'],
            'level': 'INFO',
            'propagate': False,
        },
