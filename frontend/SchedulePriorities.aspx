<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchedulePriorities.aspx.cs" Inherits="QProcess.SchedulePriorities"  MasterPageFile="PrioritiesScheduling.master" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ScriptContent">
      ...
      <script src="Scripts/SchedulePriorities.js?<%= System.IO.File.GetLastWriteTime(Server.MapPath("Scripts/SchedulePriorities.js")).Ticks.ToString() %>"></script> 	
</asp:Content>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="MainContent">
        <div>
            <div class="content" id="reportCriteria">
                        ...
                        <td>
                            ...
                            <fieldset id="scheduleDays">
                               ...
                               <%-- <div><b>Select a Report Day</b></div>
                                ...
                                <div><b>Select a Deadline Day</b></div>
                            ...
                            <fieldset id="scheduleTimes">
                                <div><b>Select a Time</b></div>
                                <div class="space">
                                     <input type="text" id="txtMeetingStartTime" style="width:100px;" />
                                </div>
                ...
                <div>
                    <table id="tblPriorityListSchedules" style="width:200px;margin-top:10px;">
                    <tbody>
