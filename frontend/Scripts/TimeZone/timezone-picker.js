...
(function(root, factory) {
    ...
    timezonePicker.prototype = {
        ...
        setValue: function(value, attribute) {
            ...
            if (elements && elements.length) {
                ...
                if (findQuickLink.length > 0)
                    findQuickLink[0].scrollIntoView({ behavior: 'smooth', inline: 'center' });
        ...
        generateMap: function(options) {
            ...
            // begin custom code to filter out to specific country
            //var tzTemp = [];
            //for (let i in timezone) {
            //    var ele = timezone[i];
            //    if (ele.country == "America" || ele.country == "US") {
            //        tzTemp.push(ele);
            //    }
            //}
            //timezone = tzTemp;
            ...
            var mapContainer = this.generateElement('div', {
                'class': 'timezone-map-container'
            });
    ...
    timezonePicker.timeZoneValue = [{
        ...
        "pin": "165,110",
        "offset": -4,
        "points": "164,110,165,110,165,111,164,111",
        "zoneName": "AST"
    }, {
