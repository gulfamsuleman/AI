...
class ChatAPIView(APIView):
    def post(self, request):
        ...
        if is_json_response:
            ...
            session.save()
            required_fields = [
                'TaskName', 'Controllers', 'Assignees', 'DueDate', 'LocalDueDate', 'Location', 'DueTime', 'SoftDueDate',
                'FinalDueDate', 'Items', 'IsRecurring', 'FreqType', 'FreqRecurrance', 'FreqInterval', 'BusinessDayBehavior',
                'Activate', 'IsReminder', 'ReminderDate', 'AddToPriorityList'
            ]
